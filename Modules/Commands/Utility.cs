...
public class Utility : ApplicationCommandModule
{
    ...
    public async Task Lookup(InteractionContext ctx,
    ...
    public async Task Markdown(InteractionContext ctx,
    ...
    public async Task CharacterCount(InteractionContext ctx,
